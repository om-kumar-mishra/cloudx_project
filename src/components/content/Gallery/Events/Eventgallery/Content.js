...
import { getEventImage } from '../../../../../redux/action/Galleryaction';
...
const Content = () => {
    ...
    const eventimgDetail = useSelector((state) => state?.GalleryReducer?.eventimageList?.table_event);
    // console.log("event img=", eventimgDetail);
    ...
    const showNext = (e) => {
        e.stopPropagation();
        let currentIndex = eventimgDetail.indexOf(imageToShow);
        if (currentIndex >= eventimgDetail.length - 1) {
            setLightBoxDisplay(false);
        } else {
            let nextImage = eventimgDetail[currentIndex + 1];
                ...
                <div className="container">
                    <div className="image-gallery-class" style={{ justifyContent: "center" }}>
                        ...
                        <div className="col-12" style={{ textAlign: "center" }}>
                            <div className="">
                                <Link to="/gallery-events"><img src='/wp-content/uploads/2023/04/back_button.png' height="50px" /></Link>
                            </div>
                        </div>
                        {/* <div className="col-12">
                            <div className="btn">
                                <Link to="/gallery-events">Back</Link>
                            </div>
                        </div> */}
                    </div>
                </div>
